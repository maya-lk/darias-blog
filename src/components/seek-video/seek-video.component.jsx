...
import { selectSeekVideoSmall , selectSeekVideoFull } from '../../redux/home/home.selectors';

import { convert, toSeconds } from './utils';
import VideoSlider from '../seek-video-slider/seek-video-slider.component';

class SeekVideoElement extends React.Component {
...
const mapStateToProps = createStructuredSelector({
    seekVideoSmall : selectSeekVideoSmall,
    seekVideoFull : selectSeekVideoFull
});

export default connect(mapStateToProps)(SeekVideoElement);